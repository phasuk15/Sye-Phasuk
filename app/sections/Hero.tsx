...
const Hero = () => {
  return (  
    <div className="w-screen h-screen flex flex-col md:flex-row">
      <div className="relative h-full flex flex-col justify-end md:justify-center items-center md:items-end px-12 w-full md:w-1/2 p-6">
      ...
      {/* Right side (image) */}
      <div className="relative flex justify-center items-center h-1/2 md:h-full w-full md:w-1/2 mt-8">
        <Image 
          src="/avatar.png" 
          alt="hero" 
